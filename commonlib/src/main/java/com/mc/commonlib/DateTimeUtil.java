...
public class DateTimeUtil {
    ...
    public static Date parseDate(String strDate) {
        ...
        try {
            ...
            Logger.e(TAG, "parse date error", e);
        }
        return returnDate;
     ...
     * 2015-01-07 15:05:34
     *
     * @param strDate yyyy-MM-dd HH:mm:ss格式日期
     * @return date
     */
    @SuppressLint("SimpleDateFormat")
